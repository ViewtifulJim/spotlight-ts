...
import logoSG from '@/images/logos/SG.png'
import image1 from '@/images/photos/code.jpg'
import image2 from '@/images/photos/bike.jpeg'
import image3 from '@/images/photos/beacons.jpeg'
import image4 from '@/images/photos/halfmarathon.jpeg'
import image5 from '@/images/photos/mountain.jpeg'
...
function Resume() {
  let resume: Array<Role> = [
    {
      company: 'BAE Systems',
      title: 'Graduate Technology Engineer',
      logo: logoBAE,
      start: '2025',
      end: {
        label: 'Present',
    ...
    },
    {
      ...
      title: 'BSc Computer Science (Hons) Student',
      logo: logoUSW,
      start: '2022',
      end: '2025',
    },
    {
      company: 'Note Machine',
      title: 'CAD Technician & Planning Coordinator',
      logo: logoNM,
      start: '2021',
      end: '2022',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
          href="/files/JamesWilliams_CV_2024.pdf"
          target="_blank"
